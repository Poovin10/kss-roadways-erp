      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 p-4 bg-slate-50 border border-slate-200 rounded-xl">
          <div className="md:col-span-2">
            <label className="block text-[10px] font-bold text-[#FF5A00] uppercase mb-1">Destination *</label>
        ...
        <div className="pt-4 border-t border-slate-200 flex flex-wrap gap-4 items-center justify-between">
          <div className="flex gap-6">
            <div>
              ...
              <p className="text-xl font-black text-[#FF5A00]">₹{(Number(loadedMt || 0) * Number(freightRate || 0)).toLocaleString(undefined, {minimumFractionDigits: 2})}</p>
            </div>
            <div>
