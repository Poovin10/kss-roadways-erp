            ...
            <form onSubmit={handleIssueDiesel} className="space-y-4">
              ...
              <div className="flex justify-between items-center bg-slate-50 p-3 rounded-lg border border-slate-200 mt-2">
                ...
                <div className="text-right">
                  ...
                  <span className="text-lg font-black text-rose-600">₹{((Number(fLitres) || 0) * (Number(fDieselRate) || 0)).toLocaleString(undefined, {minimumFractionDigits: 2})}</span>
                </div>
              </div>
            ...
            <form onSubmit={handleUpdateFuelLog} className="space-y-5 animate-in slide-in-from-bottom-4">
              ...
              <div className="flex justify-between items-center bg-slate-50 p-3 rounded-lg border border-slate-200">
                ...
                <div className="text-right">
                  ...
                  <span className="text-lg font-black text-rose-600">₹{(Number(eLitres) * Number(eRate) || 0).toLocaleString(undefined, {minimumFractionDigits: 2})}</span>
                </div>
              </div>
